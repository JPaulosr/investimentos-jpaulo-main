...
# =============================================================================
# ✅ GARANTE IMPORTS DO REPO (resolve "No module named utils" no Actions)
# =============================================================================
...
# =============================================================================
# FETCH (usa o fetcher do seu projeto)
# =============================================================================
def _load_fetcher():
    try:
        ...
        print("❌ Não conseguiu importar utils.proventos_fetch.fetch_provento_anunciado")
        print("   ERRO:", repr(e))
        return None
...
def fetch_events() -> List[Dict[str, Any]]:
    ...
    if not tickers:
        print('ℹ️ TICKERS vazio. Defina no Actions: TICKERS="PETR4,VALE3,XPML11"')
        return []
    ...
    for t in tickers:
        try:
            ...
            if not rows:
                print(f"⚠️ fetch retornou vazio: {t}")
                continue
            ...
            for r in rows:
                ...
                if not rr["ticker"] or not rr["tipo_pagamento"] or not rr["data_com"]:
                    print(
    ...
    print(f"📦 fetch_events total={len(out)}")
    return out
...
def run() -> None:
    ...
    print(f"🧾 SHEET_ID ok | tickers={TICKERS_ENV or '(vazio)'}")
